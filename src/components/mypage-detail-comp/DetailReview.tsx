...
export default () => {
  ...
  return (
    <>
      {!loading &&
        data &&
        data.getReviewByKey.map((review: any, index: number) => (
          <div className='de_re__content_group'>
            <div className='de_re_first_block'>
              ...
              <div className='de_re_first__data_group'>
                ...
                <div className='de_re_first__day_and_time'>
                  8.15 일 | 오후 3:00
                </div>
              </div>
            ...
            <div className='de_re_third_block'>
              <div className='star'>
                ...
                <div className='de_re_third__flavour'>
                  맛 {review.star.flavor}
                </div>
                <div className='de_re_third__atmosphere'>
                  분위기 {review.star.atmosphere}
                </div>
                <div className='de_re_third__price'>
                  가격 {review.star.price}
                </div>
              </div>
              <div className='evaluation_member'>
                ...
                <div className='eva_map eva_center'>
                  <img
                    className='de_icon'
                    src='/detail/review/position.png'
                    alt=''
                  />
